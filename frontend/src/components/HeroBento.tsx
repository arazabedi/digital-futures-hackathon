...
const features = [
  ...
  },
  {
    Icon: FileBox,
    name: "Database",
    description: "Contains 350+ models and counting.",
    href: "/catalog",
    cta: "Learn more",
    className: "col-span-3 lg:col-span-2",
    background: (
      <div className="absolute right-2 scale-75 top-4 h-[300px] w-[800px] border-none transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_10%,#000_100%)] group-hover:scale-105">
        <LLMCatalog />
      </div>
    ),
  },
